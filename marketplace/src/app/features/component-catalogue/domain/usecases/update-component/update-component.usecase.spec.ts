...
import { UpdateComponentUseCase } from './update-component.usecase';
...
describe('UploadImageUseCase', () => {
  let updateComponentUseCase: UpdateComponentUseCase;
  beforeAll(() => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    updateComponentUseCase = TestBed.inject(UpdateComponentUseCase);
  }));
  ...
  it('should update a fake component', (done) => {
    ...
    const $data = updateComponentUseCase.invoke(params);
    $data.subscribe((data) => {
