...
import {IProfileMicrosoftModel} from '../../../domain/models/profile-microsoft/profile-microsoft.model';

@Injectable({
  providedIn: 'root'
})
export class ProfileMicrosoftService extends IProfileMicrosoftGateway {

  constructor(private httpClient: HttpClient) {
    super();
  }

  getProfileMicrosoft(): Observable<IProfileMicrosoftModel> {
    const httpOptions = {
