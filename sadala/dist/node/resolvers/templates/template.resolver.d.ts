...
export declare abstract class TemplateResolver {
    abstract getTemplate(configuration: TemplateConfiguration): NodeListOf<Element>;
    ...
    abstract mapItemsToTemplate(items: Array<any>, template: string): Array<NodeListOf<Element>>;
}
